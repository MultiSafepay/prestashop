          ...
          <tbody>
            {foreach from=$currencies key=sort item=currency}		      
              <tr>
                ...
                {foreach from=$gateways key=sort item=gateway}	
                  {if $gateway.active == 1}
                    {if $gateway.currency[$currency.id_currency] == 'on'}
          ...
          <tbody>
            {foreach from=$groups key=sort item=group}			      
              <tr>
                ...
                {foreach from=$gateways key=sort item=gateway}	
                  {if $gateway.active == 1}
                    {if $gateway.group[$group.id_group] == 'on'}
          ...
          <tbody>
            {foreach from=$carriers key=sort item=carrier}			      
              <tr>
                ...
                {foreach from=$gateways key=sort item=gateway}	
                  {if $gateway.active == 1}
                    {if $gateway.carrier[$carrier.id_carrier] == 'on'}
            ...
            <tbody>
              {foreach from=$countries key=sort item=country}			      
                <tr>
                  ...
                  {foreach from=$gateways key=sort item=gateway}	
                    {if $gateway.active == 1}
                      {if $gateway.country[$country.id_country] == 'on'}
